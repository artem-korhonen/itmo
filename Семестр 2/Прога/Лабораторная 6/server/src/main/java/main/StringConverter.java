...
public class StringConverter {
    public static <T> T convertString(String input, Class<T> type, boolean canNull) throws StringConvertException {
    ...
    // public static int convertStringToInt(String input) throws StringConvertException {
    //     try {
    ...
    // public static double convertStringToDouble(String input) throws StringConvertException {
    //     try {
    ...
    // public static float convertStringToFloat(String input) throws StringConvertException {
    //     try {
    ...
    // public static long convertStringToLong(String input) throws StringConvertException {
    //     try {
    ...
    // public static Government convertStringToGovernment(String input) throws StringConvertException {
    //     input = input.toUpperCase().replace(" ", "_");
    //     try {
    ...
    // public static LocalDate convertStringToLocalDate(String input) throws StringConvertException {
    //     try {
