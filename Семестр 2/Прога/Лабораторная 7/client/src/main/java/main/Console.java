...
public class Console {
    ...
    public Profile profileInput() {
        String username = this.oneInput("Username", String.class, false);
        String password = this.hashInput(this.oneInput("Password", String.class, false));
